...
const Automation = () => {
  return (
    <div className="w-full min-h-[160px] mt-10 px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col items-center justify-center text-center">
...
<p className="text-[16px] sm:text-[17px] md:text-[18px] font-Montserrat text-black mt-2 w-full max-w-[90%] md:max-w-[70%] lg:max-w-[60%]">
