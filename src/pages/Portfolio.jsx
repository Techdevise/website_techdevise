    ...
    const portfolioItems = [
        {
            ...
            logo: AVBM,
            // logoBg:"bg-[#F6D083]",
            description: "AVB Marketing can help your business dominate the industry with marketing and technology solutions that secure independent retail success.",
        ...
        },
        {
            ...
            logo: Bubbles2,
            //  logoBg:"bg-[#F6D083]",
            description: "Eureka Telecom was incorporated to bring innovation in the telecommunication industry by offering modernized telecom services.",
        ...
        },
        {
            ...
            logo: Refrub2,
            //    logoBg:"bg-[#F6D083]",
            description: "Dear Customers and Partners, We warmly welcome you to Mr-Refurb, your preferred destination for high-quality, professionally refurbished hardware.",
        ...
        },
        {
            ...
            logo: TERLING,
            //   logoBg:"bg-[#F6D083]",
            description: "Sterling Forever was born from the belief that everyone deserves access to exquisite jewelry, without ever having to compromise on quality.",
        ...
        },
        {
            ...
            logo: IENGCO,
            //  logoBg:"bg-[#F6D083]",
            description: "Our expertise spans from initial concept development to detailed design, ensuring every aspect of your project is meticulously planned and executed.",
        ...
        },
        {
            ...
            logo: Pediatric2,
            //   logoBg: "bg-[#F6D083]",
            description: "Pediatric Therapy Associates is a kids focused therapy place. We are a multi-disciplinary group with the singular focus of developing your child to the fullest.",
        ...
        <div className="flex-grow bg-white relative overflow-hidden ">
            ...
            <div className="py-16 px-0 md:px-15 bg-white w-auto mx-auto">
                ...
                <div className="flex flex-wrap gap-4 justify-center mb-12">
                    {["All", "Design", "Development", "Ideas", "Technology"].map((filter, idx) => (
                        <button
                            key={idx}
                ...
                <div className="space-y-8   ">
                    {portfolioItems.map((item) => (
                        <div
                            key={item.id}
                            className={`flex flex-col ${item.layout === 'image-right' ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-6 p-6 rounded-xl w-full mx-auto`}
                            style={{
                        ...
                        >
                            ...
                            <div className="w-auto lg:w-1/2 p-4 md:p-12 pr-24  items-center justify-center">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <h2 className="font-semibold text-gray-800 mb-1 text-lg"
                                            style={{
