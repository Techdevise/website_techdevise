          ...
          <div className="relative z-10 container mx-auto min-h-[50vh]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-[20px] font-semibold mb-3 text-white font-montserrat">Services</h3>
              ...
              {/* Quick Links */}
              <div className="text-center md:text-left">
                <h3 className="font-semibold mb-3 text-white text-[20px] font-montserrat">Quick Links</h3>
                <ul className="text-white opacity-100 space-y-2 text-[18px] font-normal leading-[27px] font-montserrat">
              ...
              {/* Recent Blogs */}
              <div>
                <h3 className="font-semibold mb-3 text-white text-[20px] font-montserrat text-center md:text-left">Recent Blogs</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 footer-blog-grid">
                  {[
                    ...
                    >
                      ...
                      <p className="text-sm font-semibold text-center mt-2">Innovative Design: Crafting Seamless...</p>
