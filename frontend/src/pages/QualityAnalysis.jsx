      ...
      >
        ...
        <div className="relative text-center text-white px-6 max-w-4xl z-10 mt-20">
          <div className="relative w-full flex justify-center items-center ">
            <button className="absolute w-[160px] h-[47px] -top-16 left-[60%] transform -translate-x-1/2 bg-white bg-opacity-20 p-3 mt-[17.5rem]  rounded-full hover:bg-opacity-40">
              Quality Analysis
            </button>
          </div>
