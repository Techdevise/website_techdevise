...
const WorkModules = () => {
  ...
  return (
    <div className="work_modules w-full max-w-[1620px] h-auto px-4 py-12 md:px-16 pt-8 mx-auto relative mt-0 md:mt-10 md:pt-2">
          ...
          <div className="flex-1">
            <div className="w-full mb-6 px-4 md:px-0">
              <p className="w-full text-[16px] text-black font-Montserrat leading-6 max-w-7xl">
                <span className="text-[20px] md:text-[30px] font-Montserrat font-semibold">Content Management System</span> - Our team follows a very meticulous and precise procedure that allows us to meet the client requirements adequately within the deadline date. We take great pride in our module and the work ethic we possess.
              </p>
            </div>
            ...
            <div 
              ref={sliderRef} 
              className="flex overflow-x-hidden gap-4 md:gap-8 py-4 px-4"
            ...
            >
              ...
              <div className="min-w-[320px] sm:min-w-[412px] bg-[#D0EBFF] p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-[28px] font-Montserrat font-bold mb-3">Testing</h3>
                <p className="text-[16px] font-Montserrat">
                 We make sure that the content formulated is of the finest quality and clarifies all the queries of the target audience. The keywords incorporated are adequately placed such that it helps in the ranking aspect as well. Adequate testing is initiated to make sure that no compromise is made in quality standards.
                </p>
              </div>
              ...
              <div className="min-w-[320px] sm:min-w-[412px] bg-[#FFF0BA] p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-[28px] font-Montserrat font-bold mb-3">Quality Delivered</h3>
                <p className="text-[16px] font-Montserrat">
                 We understand your need and ensure that you get the right quality service at an affordable price. We promise to maintain quality throughout the development phase and offer quality support post delivery as well.
                </p>
              </div>
            </div>
          </div>
