...
//       style={{ background: "linear-gradient(to bottom, #0B6F4F, #021711)" }}
//     >
//       <div className="w-full max-w-[1650px] px-4">
//         {/* Heading and Skip */}
...
//             alt={categories[selectedIndex].text}
...
//                 {categories[selectedIndex].subtitle}
//               </p>
//               <button className="flex items-center gap-2 text-sm text-white font-semibold px-5 py-2 rounded-full border border-white hover:bg-white hover:text-black transition">
//                 Know More
//                 <div className="bg-white rounded-full w-6 h-6 flex items-center justify-center ml-1">
//                   <ArrowUpRight className="h-4 w-4 text-[#2DC4A9]" />
//                 </div>
