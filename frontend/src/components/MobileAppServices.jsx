...
const MobileAppServices = () => {
  return (
    <div className="mob_ser w-[1678px] bg-white flex flex-col md:flex-row items-start justify-between gap-10 py-10 mx-auto">
  ...
  <div className="mob_ser2 w-full relative z-10 bg-white/50 rounded-lg p-4 sm:p-6 md:p-8 mt-10">
    ...
    <p className="mobile_text text-black mt-8 text-sm sm:text-base md:text-[18px] font-Montserrat">
      ...
      {/* Right Side Cards */}
      <div className="mobile_cards w-full md:w-1/2 flex flex-wrap justify-center gap-4 sm:gap-6">
        {/* iOS App Development */}
        ...
        <div className="w-full sm:w-[356px] h-[161px] bg-[#99EAE0] rounded-3xl flex items-center p-4 shadow-md">
          <div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center mr-4 shrink-0">
            <img src={Androidicon} alt="Android" className="w-[32px] h-[36px]" />
          </div>
          <p className="text-black font-Montserrat font-extrabold text-[24px]">
        ...
        <div className="w-full sm:w-[356px] h-[161px] bg-[#99CBEA] rounded-3xl flex items-center p-4 shadow-md">
          <div className="w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center mr-4 shrink-0">
            <img src={Reactnativeicon} alt="React" className="w-[30px] h-[34px]" />
          </div>
          <p className="text-black font-Montserrat font-extrabold text-[24px]">
