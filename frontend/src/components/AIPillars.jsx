        ...
        <div className="w-full lg:w-[55%] px-4 sm:px-6 md:px-10 pt-6 lg:pt-[6rem] pb-10 order-1 lg:order-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-[#e6f7ff] text-[#001028] p-4 md:p-5 rounded-lg flex flex-col h-auto sm:h-[304px]">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Data Quality</h3>
            ...
            {/* Explainability */}
            <div className="bg-[#e6f7ff] text-[#001028] p-4 md:p-5 rounded-lg flex flex-col h-auto sm:h-[304px]">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Explainability</h3>
              <p className="text-sm md:text-[16px]">
            ...
            {/* Scalability */}
            <div className="bg-[#e6f7ff] text-[#001028] p-4 md:p-5 rounded-lg flex flex-col h-auto sm:h-[304px]">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Scalability</h3>
              <p className="text-sm md:text-[16px]">
            ...
            {/* Predictable ROI */}
            <div className="bg-[#e6f7ff] text-[#001028] p-4 md:p-5 rounded-lg flex flex-col h-auto sm:h-[304px]">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Predictable ROI</h3>
              <p className="text-sm md:text-[16px]">
            ...
            <div className="bg-[#e6f7ff] text-[#001028] p-4 md:p-5 rounded-lg flex flex-col h-auto sm:h-[304px] sm:col-span-2 lg:col-span-1">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Security</h3>
              <p className="text-sm md:text-[16px]">
